  ...
  return (
    <section className="flex justify-center items-center py-12 sm:py-16 px-4 bg-gradient-to-b from-white to-[#f8f9ff]">
      <div className="bg-gradient-to-r from-[#3b7ef1] to-[#281fb5] rounded-2xl shadow-[0_0_80px_rgba(63,81,181,0.3)] 
        ...
        {/* Left Text with bottom-to-top animation */}
        <motion.div
          className="text-center md:text-left flex-1"
          initial={{ y: 100, opacity: 0 }}  // bottom থেকে slide-in
        ...
        {/* Right Section (Static, no animation) */}
        <div className="flex items-center gap-3 sm:gap-5 md:gap-6 bg-white/10 rounded-full px-4 sm:px-6 py-3 sm:py-4 flex-shrink-0">
