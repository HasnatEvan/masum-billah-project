...
import before1 from "../../../../assets/SeviceImage/Image1before.png";
import after1 from "../../../../assets/SeviceImage/Image1after.png";
import before2 from "../../../../assets/SeviceImage/Image2before.png";
import after2 from "../../../../assets/SeviceImage/Image2after.png";
  ...
  return (
    <section className="bg-[#F3F6FF] py-12 sm:py-16 md:py-20 overflow-hidden">
      <div className="px-4 sm:px-6 lg:px-16 xl:px-24 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14">
        {renderCard(before1, after1, percent1, setPercent1, container1)}
        {renderCard(before2, after2, percent2, setPercent2, container2)}
      </div>
    </section>
  );
};
