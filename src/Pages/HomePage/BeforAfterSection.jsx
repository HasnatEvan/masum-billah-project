      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="relative w-[300px] sm:w-[400px] lg:w-[500px] rounded-2xl bg-white shadow-xl overflow-hidden">
            ...
            {/* Top Dots */}
            <div className="absolute top-0 left-0 right-0 h-10 sm:h-12 flex items-center px-4 bg-gradient-to-b from-white/90 to-white/70 border-b border-white/40 z-20">
