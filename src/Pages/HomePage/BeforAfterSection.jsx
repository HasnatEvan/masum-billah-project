...
import imageBefore from "../../assets/Images/beforImage.png";
import imageAfter from "../../assets/Images/afterImage.jpg";
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#3B0EA6] leading-tight mb-6">
            Our most exclusive <br className="hidden sm:block" /> Photo-editing
            services
          </h2>
