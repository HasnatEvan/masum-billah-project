...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white text-black pt-16 pb-6 px-5 sm:px-10 md:px-16 lg:px-20 border-t">
      {/* ---------- Top Grid ---------- */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-[15px] leading-relaxed text-gray-600 mb-4">
            Clipping Amazon is a professional image editing agency that provides
            high-quality, cost-effective photo editing solutions for your businesses,
            agencies, or studios.
          </p>
          ...
          <ul className="space-y-2 text-gray-700">
            {usefulLinks.map((link, i) => (
              <li key={i}>
                <NavLink
                  to={link.path}
                  className="hover:text-[#6c2bd9] transition-colors duration-300"
                >
                  {link.name}
                </NavLink>
              </li>
      ...
      <div className="max-w-7xl mx-auto mt-10 border-t border-gray-400 pt-4 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm gap-4 md:gap-0">
        <p>Copyright © Clipping Amazon 2025 All Rights Reserved</p>
